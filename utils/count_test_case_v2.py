...
class SummarizeTestCases:
    ...
    def count_test_cases(self):
        ...
        if self.tool_name == 'FreeFuzz':
            _path_to_logs_old = os.path.join(self.freefuzz_root_path, f"{self.release}.txt")
        elif self.tool_name == 'DeepRel':
            _path_to_logs_old = os.path.join(self.deeprel_root_path, f"{self.release}.txt")
        elif self.tool_name == 'ACETes':
            _path_to_logs_old = os.path.join(self.acetest_root_path, f"{self.release}.txt")
        elif self.tool_name == 'TitanFuzz':
            _path_to_logs_old = os.path.join(self.titanfuzz_root_path, f"{self.release}.txt")
        else:
